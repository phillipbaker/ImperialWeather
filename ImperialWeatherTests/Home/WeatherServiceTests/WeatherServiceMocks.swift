...
extension Data {
    static func readJson(from resource: String) throws -> Data {
        ...
        guard let path = bundle.path(forResource: resource, ofType: "json") else { throw NetworkError.invalidData }
...
extension UpcomingWeatherRaw {
    static func validDataMock() -> UpcomingWeatherRaw {
        UpcomingWeatherRaw(
            hourly: [
                HourlyWeatherRaw(dt: Date(timeIntervalSince1970: 1719925200), temp: 24.45, weather: [WeatherDescriptionRaw(icon: "04d", id: 804)]),
                HourlyWeatherRaw(dt: Date(timeIntervalSince1970: 1719928800), temp: 24.43, weather: [WeatherDescriptionRaw(icon: "04d", id: 804)]),
                HourlyWeatherRaw(dt: Date(timeIntervalSince1970: 1719932400), temp: 24.43, weather: [WeatherDescriptionRaw(icon: "04d", id: 804)])
            ],
            daily: [
                DailyWeatherRaw(

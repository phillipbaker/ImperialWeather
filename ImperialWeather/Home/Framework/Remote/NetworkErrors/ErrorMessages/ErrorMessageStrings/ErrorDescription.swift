...
enum ErrorDescription {
    ...
    static let invalidURL = NSLocalizedString(
        ...
        comment:
            """
            Error message description when the weather data request failed \
            because an invalid URL was constructed.
            """
    )
    ...
    static let invalidData = NSLocalizedString(
        ...
        comment:
            """
            Error message description when forecast data was received \
            in an invalid format and cannot be displayed.
            """
    )
}

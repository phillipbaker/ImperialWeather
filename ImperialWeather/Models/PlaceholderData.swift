...
struct PlaceholderData {
    ...
    static let currentWeatherDescription = [WeatherDescription(id: 100, description: "-", icon: "d")]
    ...
    static let upcomingWeatherDescription = [WeatherDescription(id: 100, description: "-", icon: "d")]
